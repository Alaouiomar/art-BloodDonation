package com.example.art_blooddonation.Adapter;
...
import com.example.art_blooddonation.Email.JavaMailApi;
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        String mMessage = "Hello " + nameOfTheReceiver + ", "  +nameOfSender +
                                                ...
                                                "email " + email + "\n" +
                                                "blood group " + blood + "\n" +
                                                "Kindly reach out to her/him. thank you !\n"
                                                +"Blood donnation app - donate blood to save lives ! ";
